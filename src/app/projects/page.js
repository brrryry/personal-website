	...
	return (
		<div className="space-y-5">
			...
			<ul className="list-disc mx-6 space-y-2">
				<li>
					<a href="https://github.com/brrryry/osu-beatmap-generator" target="_blank">
					...
					<p>
						...
						. the goal is to take any song and generate an osu beatmap with manually
						inputted difficulty stats.
					</p>
				</li>
				<li>
				...
				<li>
					...
					<p>
						this was a project made with discord.js. it was made for a twitch server
						that i ran at one point, but it is currently deprecated. it has a
						moderation system and a levelling system. it also communicates with the
						twitch and brawlhalla api. maybe ill keep developing it one day...
					</p>
				</li>
			</ul>
			...
			<ul className="list-disc mx-6 space-y-2">
				<li>
					...
					<p>
						under the{" "}
						<a href="https://caecommunity.org/initiative/insure" target="_blank">
							insure+e program
						</a>
						...
						infrastructure as well as several other proposed methods of bgp security
						(particularly rov++). a paper might be published soon (which means this
						can go in the linked section, yay). for now, heres a link to{" "}
						<a
