...
<a href="https://github.com/brrryry/personal-website" target="_blank">
  github
</a> for the code. all in all, i made two files: `accounts.js` for account and
session functions, and `comments.js` for comment functions.{" "}
...
<BlogList>
  ...
  <li>
    get /api/account/:userid - get all comments for a user (i bundled this with
    profile because im lazy)
  </li>
</BlogList>
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/cEpA7zDDPig?si=-mcnK1YoQn_7D87n"
