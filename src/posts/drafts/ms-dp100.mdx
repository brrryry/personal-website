...
this summer, i had the opportunity to go to the insure+e program in normal, il.
i made a blog about it [here](/blog/insure-2025). \
\
...
\
ill keep hyperlinking the sections as i go alone, so you can check out blog by blog!
...
caption="thank you so much kc for checking up and improving my code ;-; i really need that"
