...
happy new year! welcome to 2025 :)) (i started writing this blog in january, but never finished it...)
...
## osu: an introduction
if you know what osu is, you can [skip this section.](#skip-intro)
...
\
below is my strongest current attempt at the map <a href="https://osu.ppy.sh/beatmapsets/1212452" target="_blank">"flying out to the sky"</a> (6.62 star difficulty).

<br />


<video controls>
<source src="/blogs/osu-analyzer-1/osuexport.mp4" type="video/mp4"/>
...
## so what's the idea? <span id="skip-intro"/>
...
honestly, fetching the maps is probably the easiest part. i will use <a href="https://nerinyan.moe" target="_blank">nerinyan.moe</a> (an osu beatmap mirror) to download a bunch of beatmaps.
