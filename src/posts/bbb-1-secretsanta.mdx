...
## link to the project: <a href="/secretsanta">here</a>
...
<p><br/></p>
<li><u>wireshark (2024-12-06) [collin shen]</u> <br/> - when authenticating on the ``/login`` page, the username and password are sent in plaintext.
